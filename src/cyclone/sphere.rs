...
use super::errors::ShapeCreationError;
use cgmath::*;
use std::f32;
...
pub struct Sphere {
    pub vertices: glium::vertex::VertexBufferAny,
}
...
impl SphereBuilder {
    ...
    {
        let vertices = glium::vertex::VertexBuffer::<Vertex>::new(display, &self.build_vertices().unwrap());

        Ok(Sphere { vertices: glium::vertex::VertexBufferAny::from(vertices.unwrap()) })
    }
